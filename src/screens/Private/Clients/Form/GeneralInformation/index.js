  ...
  <Card cardStyle={"card--form"}>
    ...
    <Row gutter={[16, 8]}>
      <Col xs={24} sm={24} md={12} lg={12}>
        <div className="card--form--item">
          <label className="card--form--item--label">
            {t("FORM.GENERAL_INFORMATION.CLIENT_NAME")}
          </label>
          <Input
            {...bindInputProps({ name: "name", ...formik })}
            placeholder={t("FORM.GENERAL_INFORMATION.CLIENT_NAME_PLACEHOLDER")}
          />
        </div>
      </Col>
      <Col xs={24} sm={24} md={12} lg={12}>
        <div className="card--form--item">
          <label className="card--form--item--label">
            {t("FORM.GENERAL_INFORMATION.CLIENT_NUMBER")}
          </label>
          <Input
            {...bindInputProps({ name: "number", ...formik })}
            placeholder={t(
              "FORM.GENERAL_INFORMATION.CLIENT_NUMBER_PLACEHOLDER"
            )}
          />
        </div>
      </Col>
      ...
      <Col xs={24} sm={24} md={12} lg={12}>
        <div className="card--form--item">
          <label className="card--form--item--label">
            {t("FORM.GENERAL_INFORMATION.REGISTRATION_NUMBER")}
          </label>
          <Input
            {...bindInputProps({ name: "registrationNumber", ...formik })}
            placeholder={t("FORM.GENERAL_INFORMATION.REGISTRATION_NUMBER_PLACEHOLDER")}
          />
        </div>
      </Col>
      <Col xs={24} sm={24} md={12} lg={12}>
        <div className="card--form--item">
          <label className="card--form--item--label">
            {t("FORM.GENERAL_INFORMATION.VAT")}
          </label>
          <Input
            {...bindInputProps({ name: "vat", ...formik })}
            placeholder={t(
              "FORM.GENERAL_INFORMATION.VAT_PLACEHOLDER"
            )}
          />
        </div>
      </Col>
      ...
      <Col xs={24} sm={24} md={12} lg={12}>
        <div className="card--form--item">
          ...
          <Input
            ...
            placeholder={t(
              "FORM.GENERAL_INFORMATION.EMAIL_ADDRESS_PLACEHOLDER"
            )}
          />
        </div>
      </Col>
